...
sw_included = True #TOGGLE FOR PEG TRANSFER DATA, IF NOT PEG TRANSFER, SHOULD BE FALSE

if __name__ == "__main__":
    matchingPath = glob.glob('post/data/Peg*')
    mainPath = matchingPath[0]
    ...
    data = [trakstarDF, pdsDF,swLADF, swLGDF, swRADF, swRGDF]
    for s in data:
