...
def receive_smartwatch_data(server_ip, server_port, fifo_queue, recording_dir, smartwatch_id):
    ...
    newpath = f"{recording_dir}/smartwatch_data/sw_{smartwatch_id}/"
...
# receive_smartwatch_data(server_ip, server_port, fifo_queue, recording_dir)
