...
class VideoAnnotationApp(QWidget):
    ...
    def init_ui(self):
        ...
        labelGrid.addWidget(QLabel('Verb'), 0, 1)
        labelGrid.addWidget(QLabel('Instrument'), 0, 2)
    ...
    def start_segment3(self):
        ...
        # QMessageBox.information(self, 'Info', 'Track 3: Segment start position set.')
    ...
    def end_segment3(self):
        ...
        if self.current_segment3['start'] is not None and self.current_segment3['end'] is not None:
            if self.current_segment3['end'] > self.current_segment3['start']:
                ...
                # QMessageBox.information(self, 'Info', 'Track 3: Segment saved.')
                # Reset current segment
                self.current_segment3 = {
                    'start': None, 'end': None,
                    'verb': None, 'instrument': None, 'target': None
    ...
    def save_annotations(self):
        ...
        if fileName3 != '':
            ...
            # QMessageBox.information(self, 'Info', 'Annotations for Track 3 saved.')
