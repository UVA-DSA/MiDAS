...
class DefaultArgsNamespace:
    ...
    def __init__(self, cfg: Dict[str, Any], fold_index: int = 0):
        ...
        self.num_classes = len(self.dataloader_params['keysteps'])
...
if __name__ == "__main__":
    ...
    base_job_id = "SimpleModel_" + cmd_args.job_id
    ...
    for fi in fold_indices:
        ...
        model, optimizer, criterion = initialize_simple_model(args, device)
